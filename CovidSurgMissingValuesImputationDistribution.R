...
PreProc2 <- function(dataA) {
  ...
  pdf("SFig1_MissingVal1.pdf", 15, 6)
  print(Miss1)
  dev.off()

  pdf("SFig1_MissingVal2.pdf", 15, 8)
  print(Miss2)
  dev.off()
  
  #pdf("SFig1_Missing.pdf",12,7)
  #cowplot::plot_grid(Miss1, Miss2, nrow = 2, ncol = 1 )
  #dev.off()
  ...
  imputed_data <- mice(dataA2, m = 1, seed = 132)
  # imputed_data$imp$hb
  full_data <- complete(imputed_data, 1)

  save(
    list = c("imputed_data", "full_data"),
  ...
  pdf("DataDistributionImputed.pdf", 15, 9)
  ...
  return(list(full_data, dataA1Old, dataA1Labs, dataA1ImpLabs))
}
